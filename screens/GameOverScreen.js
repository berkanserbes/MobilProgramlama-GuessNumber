        ...
        <ScrollView style={styles.screen}>
            <View style={styles.rootContainer}>
                ...
                <Text style={styles.summaryText}>
                    Telefonun <Text style={styles.highlight}>{userNumber}</Text>'yi <Text style={styles.highlight}>{roundsNumber}</Text> defada bildi.
                </Text>
...
const styles = StyleSheet.create({
    ...
    imageContainer: {
        ...
        //borderRadius: deviceWidth < 380 ? 75 : 150, // half of the width/height square becomes a circle
        borderWidth: 3,
